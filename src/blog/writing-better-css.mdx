...
If you need a recap about modern CSS, check out the [Writing Better CSS article](https://www.aleksandrhovhannisyan.com/blog/writing-better-css/) by Aleksandr Hovhannisyan.
