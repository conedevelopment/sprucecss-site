...
A shorthand function to get the default focus ring styles both for `input` and `button` elements.
...
| `$btn-type`            | `'primary'`    | The color - or button type - of the button to match the ring color.  |
