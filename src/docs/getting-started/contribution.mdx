...
Please follow and use the practices under the [Structure and Code page](http://localhost:8000/docs/getting-started/structure-and-code#coding-style-guide-and-practices).
