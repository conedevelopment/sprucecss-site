...
<Preview>
  <div class="button-grid button-grid--stacked">
    <button type="button" class="btn btn--primary"><Icon type="arrow-right" className="btn__icon" /> Read more</button>
    <button type="button" class="btn btn--secondary">Read more <Icon type="arrow-right" className="btn__icon" /></button>
  </div>
</Preview>
...
<Preview>
  <div class="button-grid button-grid--stacked">
    <button type="button" class="btn btn--primary"><Icon type="arrow-right" className="btn__icon btn__icon--sm" /> Read more</button>
    <button type="button" class="btn btn--secondary">Read more <Icon type="arrow-right" className="btn__icon btn__icon--sm" /></button>
  </div>
</Preview>
