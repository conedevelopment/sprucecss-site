...
$font-size-lead: clamp(#{$font-size-lg}, 2vw, #{map.get($font-sizes, h4)}) !default;
...
- `$line-height-heading`, which is set on the headings.
The other variables (*-sm, *-md, *-lg) are generic helpers because there aren’t too many good answers here.

We use the formula for `$line-height-heding` from [Jesús Ricarte](https://kittygiraudel.com/2020/05/18/using-calc-to-figure-out-optimal-line-height/); give it a read!

[View on GitHub](https://github.com/conedevelopment/sprucecss/blob/main/scss/config/_typography.scss#L33)
...
$form-check-checkbox-border-radius: $border-radius-sm !default;
$form-check-font-size: 1.125rem !default;
$form-check-font-size-sm: $font-size-base !default;
$form-check-font-size-lg: $font-size-lg !default;
$form-check-font-weight: $form-label-font-weight !default;
$form-check-line-height: $line-height-heading !default;
$form-check-margin-block-start: 0.1em !default;
$form-check-vertical-alignment: center !default;

$form-check-focus-ring-type: outline !default;
$form-check-focus-ring-box-shadow-type: outside !default;
$form-check-focus-ring-width: 2px !default;
$form-check-focus-ring-offset: 2px !default;
```
...
$table-padding-sm: map.get($spacers, xs) !default;

$table-caption-font-size: null !default;
$table-caption-font-style: null !default;
$table-caption-font-weight: null !default;
...
<table class="table table--striped table--sm table--font-size-reset">
  <thead>
    <tr>
      <th>Name</th>
      <th>Value</th>
...
<table class="table table--striped table--sm table--font-size-reset">
  ...
  <tbody>
    <tr>
      <td>$print-page-margin</td>
      <td>2cm</td>
    </tr>
    <tr>
      <td>$print-hidden-elements</td>
      <td>'header, footer, aside, nav, form, iframe, [class^="aspect-ratio"]'</td>
    </tr>
  </tbody>
</table>
