...
If you are serious, it does not disappoint. Sass has more intermediate and advanced tools to help you build anything complex like your own CSS framework.

Sass is a little bit for CSS, like jQuery for JavaScript. It shows a direction. Today we have variables in plain CSS (which is a different variable, a more powerful one), too, which is progress.
...
Sass has a modular import system, similar to the JS modules. It replaced the classic @import rule. The @import wasn’t an advanced solution; it worked like the CSS one, except it “merged” the imported file.
...
At first, it can be more complicated than the regular @import, but in the long run, it is superior.
...
Because of the filename, you will get the “spruce” namespace. To import it without a namespace, you can do the following:
