...
<p className="lead">Typography is an essential part of any system. With Spruce, you get basic styles for the most related HTML elements.</p>
...
- You can use four different font sizing variables: `$font-size-base` (1rem), `$font-size-sm` (0.9rem), `$font-size-lg` (1.1rem) and `$font-size-lead` (math.pow($font-size-ratio, 1) * $font-size-base).
