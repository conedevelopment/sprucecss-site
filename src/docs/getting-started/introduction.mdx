...
We call it a framework because we didn’t know how to call it. It is clearly a framework of some kind but undoubtedly a smaller one.
...
<Notification type="info" icon={true}><a href="/ui/getting-started/introduction">Spruce UI</a> is a separate sister project of Spruce CSS, where you will find pre-built components.</Notification>
