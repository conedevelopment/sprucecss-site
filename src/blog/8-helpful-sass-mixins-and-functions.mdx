...
alt: 'Sass is a CSS preprocessor, like CSS on steroids, a small programming language in CSS. Wheater it is helpful for your project or not, it is a powerful tool that can solve and simplify things.'
published: true
tags: ['scss']
---
