...
| `$max-width`     | `$container-width` | Set the max-width value of the element.                                                                                            |
...
```scss
.footer {
  // @include selection(hsl(262 71% 49%));
...
| Name              | Default Value     | Description                                                      |
|-------------------|-------------------|------------------------------------------------------------------|
| `$duration`       | `'duration'`        | Get the `config('duration', $transition)` value or set a custom one.        |
| `$property`       | `all`             | Set the `transition-property` to `all`.                          |
| `$timing-function`| `'timing-function'` | Get the `config('timing-function', $transition)` value or set a custom one. |
...
| `$border-radius`                | `$border-radius-sm`                        | The border-radius of the scrollbar and handle.    |
