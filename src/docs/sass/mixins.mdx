...
| Name             | Default Value            | Description                                                                             |
|------------------|-------------------------------|-----------------------------------------------------------------------------------------|
| ```$gutter```    | ```function.spacer(m)```        | The margin value on either side of the element. The value comes from the $spacers map. |
| ```$width``` | ```true``` | Set the max-width value of the element.                                                 |
| ```$align``` | ```none``` | Set the max-width value of the element.                      |
| ```$split``` | ```0``` | Set the max-width value of the element.                      |
...
```scss
fieldset {
  @include mixin.layout-stack(function.spacer(s));
}
```
