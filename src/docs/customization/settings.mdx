...
<Notification type="info">If you want to see this in action, debug any button on this site.</Notification>
...
You can find the [complete list of utilities on GitHub](https://github.com/conedevelopment/sprucecss/blob/variable-destructure/scss/element/_utilities.scss).
