...
These mixins are called generators (a naming convention in Spruce CSS only). We wanted to distinguish because there are many of them, and their only purpose is to generate CSS styles.
