...
Use the `form-control` class on any textarea element to style it. To set the global height of it use the <code><a href="/docs/sass/variables#control">$form-control-textarea-height</a></code> variable.
...
Use the `form-control` class on any select element to style it. Use the `multiple` attribute for multiple option select.
...
Adding the `form-group--vertical-check` modifier class to the `form-group` element, you can stack them vertically or with the `form-group--horizontal-check` horizontally.
