...
<p className="lead">We just released the first version of <a href="/ui/getting-started/introduction">Spruce UI</a>, a collection set of reusable, copy-pastable HTML, CSS components (with some JS) built on Spruce CSS.</p>
