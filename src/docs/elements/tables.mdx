...
You control the stripe pattern with the <code><a href="/docs/sass/variables#tables">$table-stripe</a></code> variable (odd, even).
...
You can control the width of the scrollable table with the `$table-responsive-width` globally and locally with the `--min-width` custom property.
...
```html
<div class="table-responsive" style="--min-width: 20rem;">
  <table class="table">
    ...
  </table>
</div>
