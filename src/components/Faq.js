        ...
        <div className="faq__inner">
          ...
          <AccordionList>
            <AccordionCard title="Who is Spruce For?">
              <p>If you like to handle your CSS/SCSS in separate files and write your code, this tool is for you. It uses just a few helper classes; most <Link to="/ui/getting-started/introduction/">components</Link> are drop-ins.</p>
            </AccordionCard>
