...
$colors: (
  ...
  form: (
    ...
    range-thumb-shadow: color.adjust($color-primary, $alpha: -0.75),
    range-track-background: color.scale($color-black, $lightness: 10%),
    text: $color-gray,
...
<iframe src="https://ui.sprucecss.com/html/component/post-card-preview.html" frameborder="0" title="Post Card" loading="lazy" style="height: 34rem;"></iframe>
